...
import { X, ExternalLink, Sparkles, ShieldCheck, DollarSign } from 'lucide-react';
...
export function AdBanner({ position, adClient, adSlot, className = '' }: AdBannerProps) {
  ...
  if (!isClient || closed) return null;
    ...
    return (
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
          ...
          {/* Ad Content (Google AdSense Slot or Premium Fallback) */}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    <p className="font-semibold text-foreground group-hover:text-primary transition-colors">
                      Fast Cloud Storage & Secure Workspaces
                    </p>
                    <p className="text-[11px] text-muted-foreground hidden sm:block">
                      Enterprise-grade speed, automated backups, and 99.99% uptime SLA.
                    </p>
                  </div>
                </div>
